        ...
        {columns.map((col, colIndex) => {
          ...
          return (
            <td
              ...
              className="px-2 py-1 whitespace-nowrap text-xs text-[var(--color-foreground)]"
            >
              { (col.key === "PlannedReceiptDate" || col.key === "Date") ? formatDate(row[col.key]) : (row[col.key] ?? "") }
            </td>
          );
        })}
      </tr>
      ...
      <div className="flex justify-between items-center mb-1">
        ...
        <div className="flex gap-2 items-center">
          ...
          <button
            ...
            className="bg-[var(--color-primary)] hover:bg-[var(--color-primary)]/90 text-[var(--color-primary-foreground)] py-2 px-2 rounded-[var(--radius)] text-sm flex items-center justify-center shadow-md h-9 w-12 transition-transform duration-200 hover:scale-[1.05]"
            title="Columns"
          >
            <FileChartColumn 
              width={20} 

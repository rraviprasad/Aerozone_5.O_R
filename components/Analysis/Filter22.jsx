    ...
    <div className="mb-1">
      <div className="bg-zinc-900 border  border-white/30 rounded-xl p-2">
        ...
        >
          ...
          <input
            type="text"
            list="analysis-search-suggestions"
            placeholder="Search"
            value={search}
          ...
          <input
            type="text"
            list="analysis-description-suggestions"
      ...
      <datalist id="analysis-search-suggestions">
        {searchSuggestions.map((s, i) => (
          <option key={i} value={s} />
        ))}
      </datalist>
      <datalist id="analysis-description-suggestions">

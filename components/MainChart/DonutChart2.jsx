...
const OrderStatusDonut = ({ orderStats }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center p-2 transition-all duration-300">
      <h2 className="text-lg font-bold text-gray-300 mb-4 text-center tracking-tight">Order Status</h2>
      ...
      <div className="relative flex justify-center items-center w-full max-w-[200px] aspect-square mx-auto">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          ...
          <span className="text-[10px] uppercase font-bold tracking-widest text-gray-500">Ordered</span>
        </div>
      </div>

      <div className="mt-6 flex flex-col items-center gap-1">
        <p className="text-[11px] font-medium text-gray-500 flex items-center gap-3">
          <span>Ordered: <span className="text-white font-bold">{completed}</span></span>
